...
void button_state_process() {
  ...
  //   DebouncButCount(stop_shoot, time_stop_shoot);
  //   DebouncButCount(start_shoot, time_start_shoot);
  //   if (stop_shoot && !start_shoot) {
  //     // Serial.println("STOP SHOOT!!!");
  ...
  // else if(stateBut.SQUARE)
  // {
  //   run_step_rotate(-STEP_GO);
...
void loop() {
  ...
  // }
  //  Serial.println(pos[M_LEFT_DOWN]);
>>>>>>> 70105cd4d510e3257a3fa8cd315806e3eff7a8e2
}